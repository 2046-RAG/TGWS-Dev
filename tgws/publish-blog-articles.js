...
const articles = [
  {
    title: { en: 'How We Design VMware SRM DR for Philippine Healthcare', zh: '我們如何為菲律賓醫療機構設計 VMware SRM 災難復原方案' },
    titleZh: '我們如何為菲律賓醫療機構設計 VMware SRM 災難復原方案',
    slug: 'vmware-srm-disaster-recovery-guide',
    excerpt: { en: 'Last month, a healthcare client called us at 2am because their primary site went down. Their EHR system was down, and patients were waiting. Here\'s how we set up VMware SRM to prevent this.', zh: '上個月，一家醫療客戶凌晨兩點打電話給我們，因為他們的主站點宕機了。他們的電子健康記錄系統癱瘓，患者在等待。這是我們如何設置 VMware SRM 來防止這種情況。' },
  ...
  {
    title: { en: 'VMware vSphere 8 Upgrade: What Actually Changed and How to Plan It', zh: 'VMware vSphere 8 升級：實際變化與規劃指南' },
    titleZh: 'VMware vSphere 8 升級：實際變化與規劃指南',
    slug: 'vmware-vsphere8-upgrade-guide',
    excerpt: { en: 'If you\'re still running vSphere 7, you\'re missing out on some serious improvements. We\'ve upgraded over 30 clusters to vSphere 8, and here\'s what you need to know.', zh: '如果您仍在運行 vSphere 7，您就錯過了一些重大改進。我們已經將 30 多個集群升級到 vSphere 8，這是您需要知道的。' },
  ...
  {
    title: { en: 'VMware to Sangfor HCI: Our Migration Playbook (Step-by-Step)', zh: 'VMware 到超聚變 HCI：我們的遷移手冊（分步指南）' },
    titleZh: 'VMware 到超聚變 HCI：我們的遷移手冊（分步指南）',
    slug: 'vmware-to-sangfor-hci-migration',
    excerpt: { en: 'We\'ve migrated over 20 VMware environments to Sangfor HCI. Here\'s our battle-tested playbook that reduces downtime and avoids the common pitfalls.', zh: '我們已經將 20 多個 VMware 環境遷移到超聚變 HCI。這是我們經過實戰檢驗的手冊，可減少停機時間並避免常見陷阱。' },
  ...
  {
    title: { en: 'VMware to Proxmox VE: The Budget-Friendly Migration Path', zh: 'VMware 到 Proxmox VE：經濟實惠的遷移路徑' },
    titleZh: 'VMware 到 Proxmox VE：經濟實惠的遷移路徑',
    slug: 'vmware-to-proxmox-migration',
    excerpt: { en: 'Not every organization needs enterprise VMware licensing. We helped a manufacturing client cut virtualization costs by 80% by migrating to Proxmox VE. Here\'s how.', zh: '並非每個組織都需要企業級 VMware 許可。我們幫助一家製造客戶通過遷移到 Proxmox VE 將虛擬化成本降低了 80%。以下是具體方法。' },
  ...
  {
    title: { en: 'NSX-T in the Real World: Enterprise Deployment Lessons', zh: 'NSX-T 在實際環境中：企業部署經驗' },
    titleZh: 'NSX-T 在實際環境中：企業部署經驗',
    slug: 'nsx-t-enterprise-deployment',
    excerpt: { en: 'We\'ve deployed NSX-T for 15 enterprises across finance, healthcare, and manufacturing. Here\'s what actually works in production and what doesn\'t.', zh: '我們已經為金融、醫療和製造行業的 15 家企業部署了 NSX-T。以下是實際在生產環境中有效和無效的方法。' },
  ...
  {
    title: { en: 'VMware Horizon VDI: Designing for Remote Workforces', zh: 'VMware Horizon VDI：為遠程勞動力設計' },
    titleZh: 'VMware Horizon VDI：為遠程勞動力設計',
    slug: 'vmware-horizon-vdi-remote',
    excerpt: { en: 'Post-pandemic, 40% of our clients needed VDI solutions. We\'ve designed VMware Horizon deployments for 2,000+ concurrent users. Here\'s our architecture guide.', zh: '後疫情時代，40% 的客戶需要 VDI 解決方案。我們已經為 2000 多個並發用戶設計了 VMware Horizon 部署。這是我們的架構指南。' },
  ...
  {
    title: { en: 'VMware vs Hyper-V vs Proxmox: The 2025 Showdown', zh: 'VMware vs Hyper-V vs Proxmox：2025 年對決' },
    titleZh: 'VMware vs Hyper-V vs Proxmox：2025 年對決',
    slug: 'vmware-hyper-v-proxmox-comparison',
    excerpt: { en: 'We manage all three hypervisors in production. Here\'s an honest comparison based on real-world experience, not marketing materials.', zh: '我們在生產環境中管理所有三個虛擬機管理程序。以下是基於實際經驗的誠實比較，而非市場營銷材料。' },
  ...
  {
    title: { en: 'VMware Licensing in 2025: The Broadcom Impact and What to Do', zh: '2025 年 VMware 許可：Broadcom 的影響與應對策略' },
    titleZh: '2025 年 VMware 許可：Broadcom 的影響與應對策略',
    slug: 'vmware-licensing-changes-2025',
    excerpt: { en: 'The Broadcom acquisition changed everything. We\'ve helped 25 clients navigate the new VMware licensing model. Here\'s what you need to know and your options.', zh: 'Broadcom 的收購改變了一切。我們已經幫助 25 個客戶應對新的 VMware 許可模式。這是您需要知道的和您的選擇。' },
  ...
  {
    title: { en: 'VMware HA vs FT: Which Protection Do You Actually Need?', zh: 'VMware HA vs FT：您實際需要哪種保護？' },
    titleZh: 'VMware HA vs FT：您實際需要哪種保護？',
    slug: 'vmware-ha-vs-ft-comparison',
    excerpt: { en: 'High Availability or Fault Tolerance? We\'ve seen clients waste money on FT when HA was enough, and others suffer downtime because they only had HA. Here\'s how to decide.', zh: '高可用性還是容錯？我們見過客戶在 HA 足夠時為 FT 浪費錢，也見過其他人因為只有 HA 而遭受停機。以下是決策指南。' },
  ...
  {
    title: { en: 'VMware Migration Checklist: 10 Steps We Never Skip', zh: 'VMware 遷移檢查清單：我們從不跳過的 10 個步驟' },
    titleZh: 'VMware 遷移檢查清單：我們從不跳過的 10 個步驟',
    slug: 'vmware-migration-checklist',
    excerpt: { en: 'After 50+ VMware migrations, we\'ve distilled the process into 10 non-negotiable steps. Skip any of these, and you\'re asking for trouble.', zh: '經過 50 多次 VMware 遷移，我們將過程精煉為 10 個不可協商的步驟。跳過任何一步，您就是在自找麻煩。' },
...
async function publishArticle(article) {
  ...
  if (result.results && result.results.length > 0) {
    console.log(`✅ Published: ${article.title.en}`);
    console.log(`   ID: ${result.results[0].id}`);
  } else {
    console.error(`❌ Failed: ${article.title.en}`);
...
async function main() {
  ...
  for (let i = 0; i < articles.length; i++) {
    ...
    console.log(`\n[${i + 1}/10] Publishing: ${article.title.en}`);
