-- TechGuru Database Schema
-- Covers: [S17] Data Model
...
-- Tickets table (soft delete + audit + optimistic locking)
...
-- Ticket audit log (PRD constraint #17)
...
-- Ticket attachments (max 10MB per PRD)
...
-- Contact submissions (for CRM sync)
...
-- Tickets: admins can view/update all tickets
...
-- Comments: users can view comments on own tickets
...
-- Contact submissions: insert only (no read for customers)
