  ...
  return (
    <section className="min-h-[calc(100vh-73px)] flex items-center justify-center px-5">
      <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center max-w-lg w-full shadow-sm">
        <h1 className="text-7xl font-bold bg-gradient-to-r from-[#00D4FF] to-[#7B61FF] bg-clip-text text-transparent mb-6">
          404
        </h1>
        ...
        <Link
          href={`/${locale}/home`}
          className="inline-block px-6 py-3 bg-gradient-to-r from-[#00D4FF] to-[#7B61FF] text-white font-medium rounded-full hover:opacity-90 transition-opacity"
        >
          {t('backHome')}
        </Link>
      </div>
