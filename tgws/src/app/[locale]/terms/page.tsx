    ...
    <>
      ...
      <section className="py-20 px-5 sm:px-8 max-w-4xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed text-base">
          ...
          <p>{t('section5Body')}</p>
          <ul className="list-disc pl-6 space-y-2">
            {t.raw('section5Items').map((item: string, i: number) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">{t('section13Title')}</h2>
          <p>{t('section13Body')}</p>

          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">{t('section14Title')}</h2>
          <p>{t('section14Body')}</p>
          <ul className="list-disc pl-6 space-y-2">
            {t.raw('section14Items').map((item: string, i: number) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
        </div>
