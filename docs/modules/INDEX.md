...
| M10 | Help | /help | ✅ 完成 | 95% | —（FAQ 20 条，走 i18n 架构，2026-08-02） |
| M11 | Legal | /privacy, /terms | ✅ 完成 | 95% | — |

> 状态对齐 2026-08-02（与 TODO.md 复核一致）：M03 社交分享 ✅（TODO-014）、M05 audit_log + 测试覆盖 ✅（TODO-023/005）、M06 Odoo 降级提示 ✅（TODO-021/022）、M09 TCO 计算器 ✅（TODO-025）、M10 Help FAQ 20 条 ✅（TODO-028）。
